...
export const Players: FC = () => {
    ...
    <List>
      <ListItem>
        <ListItemIcon>
            {markFigure === MarkFigure.NOUGHT ? <IconO color='primary'/> :    <IconX color='primary'/>}
        </ListItemIcon>
        <ListItemText
          primary="You"
          secondary={truncateEthAddress(
      ...
      <ListItem>
        <ListItemIcon>
            {markFigure === MarkFigure.NOUGHT ? <IconX  color='secondary' /> :    <IconO  color='secondary' />}
        </ListItemIcon>
        <ListItemText
          primary="Opponent"
          secondary={truncateEthAddress(
